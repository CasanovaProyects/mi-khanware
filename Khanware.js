const ver = "V3.1.3-Custom";
let isDev = false;

// Cambia esta URL por tu propio repositorio
const repoPath = `https://raw.githubusercontent.com/TU-USUARIO/TU-REPO/refs/heads/${isDev ? "dev/" : "main/"}`;
...
.then(async () => {
    ...
    sendToast("🚀 MI KHANWARE PERSONALIZADO CARGADO!");
